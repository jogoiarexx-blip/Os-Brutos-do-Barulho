...
assert.equal(game.boss.pattern,1,'o primeiro padrão prepara o ferrão');
assert.equal(game.bullets.filter(b=>b.team==='enemy').length,0,'o ataque deve ser anunciado antes do disparo');
for(let i=0;i<15;i++)game.update(1);
