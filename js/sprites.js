...
export const atlases={enemies:makeImage(),support:makeImage(),effects:makeImage(),bossTrain:makeImage(),bossMammoth:makeImage(),bossVoss:makeImage(),bossScorpion:makeImage(),bossGoliath:makeImage(),outpost:makeImage(),jungleProps:makeImage(),citadelProps:makeImage()};
